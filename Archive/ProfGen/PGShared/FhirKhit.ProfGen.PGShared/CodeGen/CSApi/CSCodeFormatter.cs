    ...
    public class CSCodeFormatter : ICodeFormatter
    {
        ...
        public void StartNameSpace(String nameSpace)
        {
            ...
            this.nameSpaceBlock
                ...
                .AppendCode($"using FhirKhit.ProfGen.PGSharedLib;")
        ...
        {
            StartClass(className, fhirType, true);
        }

        /// <summary>
        /// Start creating a class.
        /// </summary>
        public void StartClass(String className, Type fhirType, bool topLevelClass)
        {
            ...
            if (cf == null)
                ...
                containingBlock = this.classes[this.classes.Count - 1].SubClassBlock;

            cf = new CSClassFormatter(this.gen, this, containingBlock, topLevelClass);
            this.classes.Add(cf);
        ...
        public void CreateProperty(ElementNode profileElement) =>
