...
namespace FhirKhit.ProfGen.XUnitTests
{
    ...
    {
#if FHIR_R2
        public string GenDir => Path.Combine(DirHelper.FindParentDir("ProfGen"), "Shared", "FhirKhit.ProfGen.PGShared.GenTests", "Generated");
        Not Implemented
...
#elif FHIR_R4
        public static string GenDir => Path.Combine(DirHelper.FindParentDir("ProfGen"), "R4", "FhirKhit.ProfGen.GenTests.R4", "Generated");
        ...
        //[Fact(DisplayName = "ProfGen.StatusError")]
        //[Trait("Test", "test")]
        //void StatusError()
        //{
        ...
        //[Fact(DisplayName = "ProfGen.CreateSnapshotOfBreastAbnormality")]
        //[Trait("Test", "test")]
